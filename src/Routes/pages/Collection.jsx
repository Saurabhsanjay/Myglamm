import { Box, HStack, Image, SimpleGrid, Text, Spacer,VStack,Divider } from '@chakra-ui/react'
import React, { useContext } from 'react'
import {  useNavigate } from 'react-router-dom'
import { AppContext } from '../../context/Appcontext'

const Collection = () => {
  const { AllData,shortStringdesc,MeMoJi,MeMoJi1,MeMoJi2,shortString} = useContext(AppContext)
  ...
  return (
    ...
    <VStack>
      ...
      >
        {AllData?.CollectionProducts.map((el, i) => {
          return (
            <Box
              cursor={"pointer"}
